            ...
            <Box borderBottom={1} borderColor="divider">
                <Grid container wrap="nowrap">
                    ...
                    >
                        <Grid item>
                            <IconButton
                                href="https://github.com/mohammmmmmmmmmed/split-and-pay"
                                target="_blank"
                            >
                                <GitHubIcon />
                            </IconButton>
            ...
            >
                <DialogTitle id="scroll-dialog-title">
                    <Typography display="flex" alignItems="center" justifyContent="center">
                        <VerticalSplit />
                        <Typography ml="0.65rem" fontWeight="bold" variant="h6">Split-&-Pay - Split trip expenses with ease</Typography>
                    </Typography>
                </DialogTitle>
                <DialogContent dividers={true}>
                    ...
                    <DialogContentText marginTop="24px" textAlign="right">
                        <sub>
                            Built with ❤︎ by  <a href="https://github.com/mohammmmmmmmmmed">Mohammed Sahal</a>
                        </sub>
                    </DialogContentText>
                </DialogContent>
            </Dialog>
